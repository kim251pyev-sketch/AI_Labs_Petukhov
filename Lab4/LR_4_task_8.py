...
for i in range(X.shape[0]):
    plt.scatter(X[i, 0], X[i, 1], marker=mapper[i], s=75, edgecolors='black', facecolors='none')
plt.scatter(test_datapoint[0], test_datapoint[1], marker='x', s=200, linewidth=6, color='black')
...
for i in indices:
    plt.scatter(X[i, 0], X[i, 1], marker=mapper[y[i]], s=100, linewidth=3, facecolors='black')
plt.scatter(test_datapoint[0], test_datapoint[1], marker='x', s=200, linewidth=6, color='black')
for i in range(X.shape[0]):
    plt.scatter(X[i, 0], X[i, 1], marker=mapper[i], s=75, edgecolors='black', facecolors='none')
